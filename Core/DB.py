...
class DB:
    ...
    **Reference**
    ...
    __TEST_SRC: Final[Dict[str, Type.FileSrc]] = {
        ...
        'recigamma_small_ref': Type.FileSrc('../Test/Ref/Test_Recigamma_Small.ref', 'Recigamma test input', False),
        'recigamma_medium_ref': Type.FileSrc('../Test/Ref/Test_Recigamma_Medium.ref', 'Recigamma test input', False),
        'recigamma_large_ref': Type.FileSrc('../Test/Ref/Test_Recigamma_Large.ref', 'Recigamma test input', False),
        ...
        'centralbeta_small_ref': Type.FileSrc('../Test/Ref/Test_Centralbeta_Small.ref', 'Centralbeta test input',
                                              False),
        'centralbeta_medium_ref': Type.FileSrc('../Test/Ref/Test_Centralbeta_Medium.ref', 'Centralbeta test input',
                                               False),
        'centralbeta_large_ref': Type.FileSrc('../Test/Ref/Test_Centralbeta_Large.ref', 'Centralbeta test input',
                                              False),
        'sinc_small_ref': Type.FileSrc('../Test/Ref/Test_Sinc_Small.ref', 'Sinc test input', False),
        'sinc_medium_ref': Type.FileSrc('../Test/Ref/Test_Sinc_Medium.ref', 'Sinc test input', False),
        'sinc_large_ref': Type.FileSrc('../Test/Ref/Test_Sinc_Large.ref', 'Sinc test input', False),
        'tanc_small_ref': Type.FileSrc('../Test/Ref/Test_Tanc_Small.ref', 'Tanc test input', False),
        'tanc_medium_ref': Type.FileSrc('../Test/Ref/Test_Tanc_Medium.ref', 'Tanc test input', False),
        'tanc_large_ref': Type.FileSrc('../Test/Ref/Test_Tanc_Large.ref', 'Tanc test input', False),
        'sinhc_small_ref': Type.FileSrc('../Test/Ref/Test_Sinhc_Small.ref', 'Sinhc test input', False),
        'sinhc_medium_ref': Type.FileSrc('../Test/Ref/Test_Sinhc_Medium.ref', 'Sinhc test input', False),
        'sinhc_large_ref': Type.FileSrc('../Test/Ref/Test_Sinhc_Large.ref', 'Sinhc test input', False),
        'coshc_small_ref': Type.FileSrc('../Test/Ref/Test_Coshc_Small.ref', 'Coshc test input', False),
        'coshc_medium_ref': Type.FileSrc('../Test/Ref/Test_Coshc_Medium.ref', 'Coshc test input', False),
        'coshc_large_ref': Type.FileSrc('../Test/Ref/Test_Coshc_Large.ref', 'Coshc test input', False),
        'tanhc_small_ref': Type.FileSrc('../Test/Ref/Test_Tanhc_Small.ref', 'Tanhc test input', False),
        'tanhc_medium_ref': Type.FileSrc('../Test/Ref/Test_Tanhc_Medium.ref', 'Tanhc test input', False),
        'tanhc_large_ref': Type.FileSrc('../Test/Ref/Test_Tanhc_Large.ref', 'Tanhc test input', False),
        ...
        'dirichletkernel_large_ref': Type.FileSrc('../Test/Ref/Test_Dirichletkernel_Large.ref',
                                                  'Dirichletkernel test input', False),
        'fejerkernel_small_ref': Type.FileSrc('../Test/Ref/Test_Fejerkernel_Small.ref', 'Fejerkernel test input',
                                              False),
        'fejerkernel_medium_ref': Type.FileSrc('../Test/Ref/Test_Fejerkernel_Medium.ref', 'Fejerkernel test input',
                                               False),
        'fejerkernel_large_ref': Type.FileSrc('../Test/Ref/Test_Fejerkernel_Large.ref', 'Fejerkernel test input',
                                              False),
        'topologistsin_small_ref': Type.FileSrc('../Test/Ref/Test_Topologistsin_Small.ref', 'Topologistsin test input',
                                                False),
        'topologistsin_medium_ref': Type.FileSrc('../Test/Ref/Test_Topologistsin_Medium.ref',
                                                 'Topologistsin test input', False),
        'topologistsin_large_ref': Type.FileSrc('../Test/Ref/Test_Topologistsin_Large.ref', 'Topologistsin test input',
                                                False)
    }
