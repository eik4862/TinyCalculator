...
class Exp:
    ...
    __sign: Dict[Type.FunT, List[Type.Sign]] = {
        ...
        Type.FunT.POW: [Type.Sign([Type.T.NUM, Type.T.NUM], Type.T.NUM, Type.FunT.POW)],
        Type.FunT.SQRT: [Type.Sign([Type.T.NUM], Type.T.NUM, Type.FunT.SQRT)],
        Type.FunT.LOG2: [Type.Sign([Type.T.NUM], Type.T.NUM, Type.FunT.LOG2)],
        Type.FunT.LOG10: [Type.Sign([Type.T.NUM], Type.T.NUM, Type.FunT.LOG10)]
    }
